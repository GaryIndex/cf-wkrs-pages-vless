...
// 生成配置文件的 CF 优选 IP
const bestCFIP = "quiz.video.com"

// 用于 CF 网站的代理 IP
const proxyIPs = ["178.128.91.137"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
